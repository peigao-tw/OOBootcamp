...
public class ParkingManagerTest 
{
    ...
    [Test]
    public void should_park_general_car_vehicle_successful_when_graduate_can_given_3_type_parking_boy()
    {
    }

    [Test]
    public void should_park_general_car_vehicle_successful_when_graduate_cant_given_3_type_parking_boy()
    {
    }

    [Test]
    public void should_park_general_car_vehicle_successful_when_graduate_smart_cant_given_3_type_parking_boy()
    {
    }

    [Test]
    public void should_park_general_car_vehicle_successful_when_graduate_smart_specialized_cant_given_3_type_parking_boy()
    {
    }
}
